...
paper. \cmd{DATA\_MANIFEST.md} records the mapping. The archive
sibling directory holds 1.1 GB of regenerable finite-element meshes
moved out of the tree before release; the meshing scripts rebuild
them if rerun.
