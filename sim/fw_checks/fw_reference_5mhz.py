...
~8 GB, ~2.6 h on the RTX 4070. Saves ref/fw_reference_5mhz_fabric00.npz and prints
...
def main():
    ...
    np.savez(os.path.join(REF, "fw_reference_5mhz_fabric00.npz"), trace=tr, dt=dt,
    ...
    # decontaminated 2 MHz fabric00 reference (fw_reference_2mhz_2mhz.py, damp
