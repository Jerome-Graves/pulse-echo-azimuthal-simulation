...
Round-1 forensics (fe_arbiter_round1_baseline_traces.npz): FE uniform-B carried
...
from fe_arbiter_round1_baseline import analyse, T             # noqa: E402
...
def get_mesh():
    import os
    path = "fe_arbiter_round2_padded_box_mesh.npz"
...
def main():
    ...
    np.savez("fe_arbiter_round2_padded_box_traces.npz", fa=fa, fb=fb, dtf=dtf,
             ea=ea, eb=eb, dte=dte)
