...
singlemax_ppw8 finished after the born_spec result was obtained, so it is
a genuine prediction test: nothing was tuned on it.

It also completes the pair the mean-level question needed all along:
  girdle_perp_ppw8   seed 11, kappa -8.0  (girdle, normal in-plane)
  singlemax_ppw8     seed 11, kappa +3.93 (single max, in-plane axis)
...
PAIR = [("singlemax_ppw8", 3.93, (0.866, 0.5, 0.0), "single max k=+3.93"),
        ("girdle_perp_ppw8", -8.0, (1.0, 0.0, 0.0), "girdle k=-8 in-plane")]
...
a, b = res["singlemax_ppw8"], res["girdle_perp_ppw8"]
