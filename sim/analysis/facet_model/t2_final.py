...
MODE = "harm"
CASES = [
    ("girdle_perp_ppw8", "gp8", "CORRECT"),
    ("singlemax_ppw8", "sm8", "CORRECT"),
    ("iso_gcal", "iso6", "random-fabric sweep, own tessellation"),
    ...
    ("iso_gcal", "wrongseed6", "WRONG tessellation"),
]
...
for sw, tg in (("girdle_perp_ppw8", "gp8"), ("singlemax_ppw8", "sm8")):
