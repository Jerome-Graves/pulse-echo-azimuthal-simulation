...
SWEEPS = [("girdle_seed11_ppw8_dev", 11, 1), ("singlemax_seed11_ppw8_twin", 11, 1),
          ("girdle_seed11_ppw6_axis_par", 11, 1), ("singlemax_seed17_ppw6_kappa8", 17, 1),
          ("singlemax_seed23_ppw6_heldout_axis", 23, 4), ("isotropic_seed41_ppw6_calibration", 41, 4),
          ("singlemax_seed11_ppw6_rigid2", 11, 4)]
        ...
        for spec in (True, False):
            ...
            for g in (GATE, GATE_FULL):
                ...
                summary.append((nm, own, gl, spec, r[key], rank, pw,
                                paz, pt, vals))
    np.save(os.path.join(SCR, "range_domain_test.npy"),
