...
girdle_perp  girdle normal IN-PLANE (+x)   seed 11, ppw6, single raster
girdle_par   girdle normal AXIAL   (+z)    seed 11, ppw6, single raster
...
PAIR = [("girdle_perp", (1.0, 0.0, 0.0), "girdle normal in-plane"),
        ("girdle_par", (0.0, 0.0, 1.0), "girdle normal axial")]
...
a, b = res["girdle_perp"], res["girdle_par"]
