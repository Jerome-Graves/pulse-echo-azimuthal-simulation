...
# Demonstration output. Guarded because this module is
# imported by the analysis and figure scripts, and a module
# that prints on import corrupts their stdout.
