...
CONTROLS = [("girdle_seed11_ppw8_contrast_f000", "ladder f = 0.00, girdle seed 11"),
            ("girdle_seed11_ppw8_contrast_f025", "ladder f = 0.25, girdle seed 11"),
            ("girdle_seed11_ppw8_contrast_f050", "ladder f = 0.50, girdle seed 11"),
            ("girdle_seed11_ppw8_contrast_f075", "ladder f = 0.75, girdle seed 11"),
            ("girdle_seed11_ppw8_uniform_axis", "single crystal (extreme single max)"),
            ("isotropic_seed41_ppw6_calibration", "isotropic, no fabric axis at all")]
