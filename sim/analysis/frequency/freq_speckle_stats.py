...
rows = []
for nm, tag in (("singlemax_seed7_ppw6_fittest_legacy", "2 MHz"), ("singlemax_seed7_ppw6_5mhz_production", "5 MHz")):
...
np.savez("freq_speckle_stats.npz", **{k: v for k, v in store.items()})
