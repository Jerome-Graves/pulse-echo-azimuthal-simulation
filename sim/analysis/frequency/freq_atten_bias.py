...
E2 = env_grid("singlemax_seed7_ppw6_fittest_legacy", AZ5)
E5 = env_grid("singlemax_seed7_ppw6_5mhz_production", AZ5)
...
np.savez("freq_atten_bias.npz", corr=corr, corr_lo=min(clo, chi),
